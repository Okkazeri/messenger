...
class Ui_ChatMainWindow(object):
    def setupUi(self, ChatMainWindow):
        ...
        ChatMainWindow.setStyleSheet("background-color: black;")
        ...
        self.chat_window.setStyleSheet("color: green;")
        ...
        self.send_text.setStyleSheet("color: green;")
        ...
        self.send_btn.setStyleSheet("color: green;")
