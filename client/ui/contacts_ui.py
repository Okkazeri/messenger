...
class Ui_ContactsWindow(object):
    def setupUi(self, ContactsWindow):
        ...
        ContactsWindow.setStyleSheet("background-color: black")
        ...
        self.all_contacts.setStyleSheet("color: green;")
        ...
        self.new_contact_name.setStyleSheet("color: green;")
        ...
        self.add_new_contact_btn.setStyleSheet("color: green;")
        ...
        self.delete_contact_btn.setStyleSheet("color: green;")
        ...
        self.menubar.setStyleSheet("color: green;")
