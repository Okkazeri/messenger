...
class Ui_Login_Dialog(object):
    def setupUi(self, Login_Dialog):
        ...
        Login_Dialog.setStyleSheet("background-color: black;")
        ...
        self.username_text.setStyleSheet("color: lime;")
        ...
        self.password_text.setStyleSheet("color: lime;")
        ...
        self.login_btn.setStyleSheet("color: lime;")
